...
template_data = YAML.load_file(Rails.root.join("lib/templates/usa.yml"))
...
puts "Seeded #{InspectionTemplate.count} inspection templates"
puts "Seeded #{ChecklistItem.count} checklist items"
puts "Template: #{template.name} (#{template.checklist_items.size} items)"
